...
##    for x in df.index:
##        print(df['Low
##        df['p'].loc[x]=df['High'].loc[x]-df['Low'].loc[x]
##    print(df[['p','High','Low']],'  p test columns')       
...
##    
    ...
    print('reaading 1sr blk',end-start)
...
##        df['Volumea']=(df['Volume']-df['Volume'].shift(1))
        ...
        df['Price_200']=df['Close'].loc[x]-df['EMA_200'].loc[x]
        df['Price_100']=df['Close'].loc[x]-df['EMA_100'].loc[x]
        df['Price_50']=df['Close'].loc[x]-df['EMA_50'].loc[x]
        df['Price_21']=df['Close'].loc[x]-df['EMA_21'].loc[x]
        df['Price_10']=df['Close'].loc[x]-df['EMA_10'].loc[x]
        df['Price_5']=df['Close'].loc[x]-df['EMA_5'].loc[x]
        ...
        df['swng'].loc[x]=df['High'].loc[x]-df['Low'].loc[x]*0.99999

    end2=time.time()
    print('reaading 2rd blk: ',end2-start2)

    start3=time.time()
    
##    print(df,'df output')
##    print(df[['swng','Low','High']],'khan')
#########################################################################
    ...
    gg33=tt[['index', 'Datetime','ticker', 'pivot','pivotx','pp','*','Close_1d_ch','*','r1','r2','r3','*','s1','s2','s3','*','volatility','*',
            ...
            'ppx','*','r1x','r2x','r3x','*','s1x','s2x','s3x','*','*',
             ...
             'Price_from_BBUP','Price_from_BBLWR','Price_from_BBMid','bol_wd',
              ...
              'Price_200','Price_100','Price_50','Price_21','Price_10','Price_5'
...
##               'Buy_5EMA_10EMA','Buy_5EMA_21EMA','Buy_21EMA_50EMA','Buy_50EMA_100EMA','Buy_100EMA_200EMA',
##         'adx','aroondown','aroonup','AROONOSC','SAR','SAREXT','High','Low','Open',
##         'delta_Low','delta_High','delta_Open','delta_Close','Candle','Close_1d_ch','Volume',
...
##              'aroonup','aroondown','adx','STOCHRSI_fastk','ROC','macdhist', 'WilliamsR','CCI','direct' ,'HA','MOM', 'Close_1d_ch' ,'swng','Candle']]
    ...
    print("reaading 3rd blk", end3-start3)
...
####################### 5-10 crossover ###########################3
    ...
    for x in gg33b.index:
##        print('kkkkk',type(gg33b['5_10_crossovr'].loc[x]))
        if gg33b['5_10_crossovr'].loc[x] > 0:
            if gg33b['5_10_crossovr'].shift(1).loc[x] < 0:
                p8_5_10_b.append(x)
    print('5_10_crossovr ---> ', p8_5_10_b)
    for x in gg33b.index:
        for y in p8_5_10_b:
            if x==y:
    ...
    for x in gg33b.index:  
        if gg33b['10_21_crossovr'].loc[x] > 0:
            if gg33b['10_21_crossovr'].shift(1).loc[x] < 0:
                p8_10_21_b.append(x)
    print('10_21_crossovr --> ',p8_10_21_b)
    for x in gg33b.index:
        for y in p8_10_21_b:
            if x==y:
...
####################### 10-21 crossover ###########################3
    ...
    for x in gg33b.index:  
        if gg33b['10_21_crossovr'].loc[x] < 0:
            if gg33b['10_21_crossovr'].shift(1).loc[x] > 0:
                p8_10_21_s.append(x)
    print('10_21_crossovr --> ',p8_10_21_s)
    for x in gg33b.index:
        for y in p8_10_21_s:
            if x==y:
    ...
    for x in gg33b.index:  
        if gg33b['21_50_crossovr'].loc[x] > 0:
            if gg33b['21_50_crossovr'].shift(1).loc[x] < 0:
                p8_21_50_b.append(x)
    print('21_50_crossovr --> ',p8_21_50_b)
    for x in gg33b.index:
        for y in p8_21_50_b:
            if x==y:
...
####################### 21-50 crossover ###########################3
    ...
    for x in gg33b.index:  
        if gg33b['21_50_crossovr'].loc[x] < 0:
            if gg33b['21_50_crossovr'].shift(1).loc[x] > 0:
                p8_21_50_s.append(x)
    print('21_50_crossovr --> ',p8_21_50_s)
    for x in gg33b.index:
        for y in p8_21_50_s:
            if x==y:
    ...
    for x in gg33b.index:  
        if gg33b['50_100_crossovr'].loc[x] > 0:
            if gg33b['50_100_crossovr'].shift(1).loc[x] < 0:
                p8_50_100_b.append(x)
    print('50_100_crossovr --> ',p8_50_100_b)
    for x in gg33b.index:
        for y in p8_50_100_b:
            if x==y:
...
####################### '50_100_crossovr' ###########################3
    ...
    for x in gg33b.index:  
        if gg33b['50_100_crossovr'].loc[x] < 0:
            if gg33b['50_100_crossovr'].shift(1).loc[x] > 0:
                p8_50_100_s.append(x)
    print('500_100_crossovr --> ',p8_50_100_s)
    for x in gg33b.index:
        for y in p8_50_100_s:
            if x==y:
    ...
    for x in gg33b.index:  
        if gg33b['100_200_crossovr'].loc[x] > 0:
            if gg33b['100_200_crossovr'].shift(1).loc[x] < 0:
                p8_100_200_b.append(x)
    print('100_200_crossovr --> ',p8_100_200_b)
    for x in gg33b.index:
        for y in p8_100_200_b:
            if x==y:
...
####################### '100_200_crossovr' ###########################3
    ...
    for x in gg33b.index:  
        if gg33b['100_200_crossovr'].loc[x] < 0:
            if gg33b['100_200_crossovr'].shift(1).loc[x] > 0:
                p8_100_200_s.append(x)
    print('100_200_crossovr --> ',p8_100_200_s)
    for x in gg33b.index:
        for y in p8_100_200_s:
            if x==y:
                gg33b.loc[x,'signal48']='Sell_100_200'
    print(gg33b,' nnnnn')
    print(gg33b.shape,'5555')
    print(gg33b.shape[0]-1,'  hello')
    print(gg33b[(gg33b.shape[0]-2)],' ffff')
...
##    print('\n\n')
##
##    a=len(p8_100_200_s)-1
##    b=len(p8_100_200_b)-1
##    if p8_100_200_s[a] > p8_100_200_b[b]:
##        print('100_200_[sell]_signal')
##    if p8_100_200_s[a] < p8_100_200_b[b]:
##        print('100_200_[buy]_signal')
###############################################################
...
##
    ...
    print('Calculation based upon, # of rows : ', gg33b.shape[0])

        
        # Summary 
##    print("ticker--- > ",ticker, '/100-200 signal')
##    print('\n\n')
    
##    print('\n\n\n')
##    print('Summary')
##    print('5_10_sell : ',p8_5_10_s,'\n',len(p8_5_10_s))
##    print('\n')
##    print('5_10_buy : ',p8_5_10_b,'\n',len(p8_5_10_b))
##    print('*************************************************************************')
##    print(ticker)
##    
##    print('214 695 Last price--> ',)
##    print('\n')
##    print('*************************************************************************')
##    print('\n')
...
##    print("ticker--- > ",ticker,'/5_10 signal')
##    print('\n\n')

    a=len(p8_5_10_s)-1
    b=len(p8_5_10_b)-1
    last_current_price=gg33b['Close'].loc[gg33b.shape[0]-1]
# delete below    
##    print('len of a= ',a,' len of b= ',b,'  bbbbbb  ')
##    print('\n')
##    print('\n')
####    print('p8_5_10_b','len b=',b,' ', p8_5_10_b)
####    print('\n')
##    print('p8_5_10_a', 'len a=',a,' ',p8_5_10_s)
##
##    print("4444 gg33b['Close'].loc[gg33b.shape[0]-1]  ",gg33b['Close'].loc[gg33b.shape[0]-1],gg33b['Close'].tail(4))
##          
##,gg33b['Close'].loc[a],' ',gg33b['Close'].loc[b]
##    if a=0:
##        a=1
##    if b=0:
##        b=1   64822.56

##    print('bingo 44','  a= ',a,'  b=',b)
    
##    print('len of a ',a,'  ','len of b ',b, '   p8_5_10_s[a]=',p8_5_10_s[a],'  ','p8_5_10_b[b]=',p8_5_10_b[b])
##    print('pppp3333',gg33b['Close'].loc[a].to_string(header=None, index=None))
    ...
    print('214 695 Last price--> ',last_current_price)
    print('\n')
    print('*************************************************************************')
    print('\n\n')

    if  p8_5_10_s[a] >  p8_5_10_b[b]:
##        print('5_10_[sell]_signal','    Price when signal came in ',gg33b['Close'].loc[a])
##        print('Price [down] from signal: ******  ',gg33b['Close'].loc[gg33b.shape[0]-1]-gg33b['Close'].loc[a], ' ******')
# 


        print('5_10_[sell]_signal','signal @ ',gg33b['Close'].loc[a],' Current @ :',last_current_price, 'big',
              'delta=',gg33b['Close'].loc[a]-last_current_price,' # of sells/buy signals today=',a,'/',b)
##        print('Price [down] from signal: ******  ',gg33b['Close'].loc[gg33b.shape[0]-1]-gg33b['Close'].loc[a], ' ******')
        
##        , gg33b['Close'].loc[b],'** Current @:', last_current_price,' small'
##        f=open('\home\az2\dummy334.txt',"w")
##        f.write('sell ')
##        f.write(str(p8_5_10_s[a]))
##        f.close
        
    if p8_5_10_s[a] < p8_5_10_b[b]:
        print('5_10_[buy]_signal',' Price @ ', gg33b['Close'].loc[b],'** Current @:', last_current_price,' small',
                'delta=',last_current_price-gg33b['Close'].loc[b],' # of sells/buy signals today=',a,'/',b)
##        print('Price [up] by: ****** ',gg33b['Close'].loc[gg33b.shape[0]-1]-gg33b['Close'].loc[b], ' ******')
##        f=open('\home\az2\dummy334.txt','w')
##        f.write('buy ')
##        f.write(str(p8_5_10_b[b]))
##        f.close
#############################################################
#############################################################
        #############################################################
##    print("ticker--- > ",ticker,'/10_21 signal')
##    print('\n\n')

    a=len(p8_10_21_s)-1
    b=len(p8_10_21_b)-1
    if  p8_10_21_s[a] >  p8_10_21_b[b]:
        print('10_21_[sell]_signal','signal @ ',gg33b['Close'].loc[a],' Current @ :',last_current_price, 'big',
              'delta=',gg33b['Close'].loc[a]-last_current_price,' # of sells/buy signals today=',a,'/',b)
    if p8_10_21_s[a] < p8_10_21_b[b]:
        print('10_21_[buy]_signal',' Price @ ', gg33b['Close'].loc[b],'** Current @:', last_current_price,' small',
                'delta=',last_current_price-gg33b['Close'].loc[b],' # of sells/buy signals today=',a,'/',b)
#############################################################        
        #############################################################
##    print("ticker--- > ",ticker,'/21_50 signal')
##    print('\n\n')

    a=len(p8_21_50_s)-1
    b=len(p8_21_50_b)-1
    if p8_21_50_s[a] > p8_21_50_b[b]:
        print('21_50_[sell]_signal','signal @ ',gg33b['Close'].loc[a],' Current @ :',last_current_price, 'big',
              'delta=',gg33b['Close'].loc[a]-last_current_price,' # of sells/buy signals today=',a,'/',b)
    if p8_21_50_s[a] < p8_21_50_b[b]:
        print('21_50_[buy]_signal',' Price @ ', gg33b['Close'].loc[b],'** Current @:', last_current_price,' small',
                'delta=',last_current_price-gg33b['Close'].loc[b],' # of sells/buy signals today=',a,'/',b)
        #############################################################        
#############################################################
##    print("ticker--- > ",ticker,'/50_100 signal')
##    print('\n\n')

    a=len(p8_50_100_s)-1
    b=len(p8_50_100_b)-1
    if p8_50_100_s[a] > p8_50_100_b[b]:
        print('50_100_[sell]_signal','signal @ ',gg33b['Close'].loc[a],' Current @ :',last_current_price, 'big',
              'delta=',gg33b['Close'].loc[a]-last_current_price,' # of sells/buy signals today=',a,'/',b)
    if p8_50_100_s[a] < p8_50_100_b[b]:
        print('50_100_[buy]_signal',' Price @ ', gg33b['Close'].loc[b],'** Current @:', last_current_price,' small',
                'delta=',last_current_price-gg33b['Close'].loc[b],' # of sells/buy signals today=',a,'/',b)
...
########################################################
    ...
    b=len(p8_100_200_b)-1
    if p8_100_200_s[a] > p8_100_200_b[b]:
        print('100_200_[sell]_signal','signal @ ',gg33b['Close'].loc[a],' Current @ :',last_current_price, 'big',
              'delta=',gg33b['Close'].loc[a]-last_current_price,' # of sells/buy signals today=',a,'/',b)
    if p8_100_200_s[a] < p8_100_200_b[b]:
        print('100_200_[buy]_signal',' Price @ ', gg33b['Close'].loc[b],'** Current @:', last_current_price,' small',
                'delta=',last_current_price-gg33b['Close'].loc[b],' # of sells/buy signals today=',a,'/',b)

    print('\n\n')
    print('**************************************************************************************************************')
    print('                                     Current Alert just now                           ')
    print('\n\n')
    if gg33b['signal44'].shape[0]-1 != ' ' or gg33b['signal44'].shape[0]-1  is not None:
        print('5-10 crossover signal alert now -----> ',gg33b['signal44'].shape[0]-1)
##
    if gg33b['signal45'].shape[0]-1 != ' ' or gg33b['signal45'].shape[0]-1  is not None:
        print('10-21 crossover signal alert now -----> ',gg33b['signal45'].shape[0]-1)
        
    if gg33b['signal46'].shape[0]-1 != ' ' or gg33b['signal46'].shape[0]-1  is not None:
        print('21-50 crossover signal alert now -----> ',gg33b['signal46'].shape[0]-1)
        
    if gg33b['signal47'].shape[0]-1 != ' ' or gg33b['signal47'].shape[0]-1  is not None:
        print('50-100 crossover signal alert now -----> ',gg33b['signal47'].shape[0]-1)
        
    if gg33b['signal48'].shape[0]-1 != ' ' or gg33b['signal48'].shape[0]-1  is not None:
        print('100-200 crossover signal alert now -----> ',gg33b['signal48'].shape[0]-1)

##    if  (len(gg33b['signal44'].shape[0]-1) < 1 or len(gg33b['signal45'].shape[0]-1) > 1 or
##        len(gg33b['signal46'].shape[0]-1) < 1 or len(gg33b['signal47'].shape[0]-1) > 1 or
##        len(gg33b['signal48'].shape[0]-1) < 1):
##            print(" No alert")

            

##    if gg33b['Close'].shape[0]-1 > gg33b['Price_200'].shape[0]-1:
##        "Price > 200"
##    if gg33b['Close'].shape[0]-1 < gg33b['Price_200'].shape[0]-1:
##        "Price < 200"
##
##    if gg33b['Close'].shape[0]-1 > gg33b['Price_100'].shape[0]-1:
##        "Price > 100"
##    if gg33b['Close'].shape[0]-1 < gg33b['Price_100'].shape[0]-1:
##        "Price < 100"
##
##    if gg33b['Close'].shape[0]-1 > gg33b['Price_50'].shape[0]-1:
##        "Price > 50"
##    if gg33b['Close'].shape[0]-1 < gg33b['Price_50'].shape[0]-1:
##        "Price < 50"
##
##    if gg33b['Close'].shape[0]-1 > gg33b['Price_21'].shape[0]-1:
##        "Price > 21"
##    if gg33b['Close'].shape[0]-1 < gg33b['Price_21'].shape[0]-1:
##        "Price < 21"
##
##    if gg33b['Close'].shape[0]-1 > gg33b['Price_10'].shape[0]-1:
##        "Price > 10"
##    if gg33b['Close'].shape[0]-1 < gg33b['Price_10'].shape[0]-1:
##        "Price < 10"
##
##    if gg33b['Close'].shape[0]-1 > gg33b['Price_5'].shape[0]-1:
##        "Price > 5"
##    if gg33b['Close'].shape[0]-1 < gg33b['Price_5'].shape[0]-1:
##        "Price < 5"     
    ...
    print('\n\n')
    print('reaading 1sr blk',end-start)
    print('reaading 2nd blk',end2-start2)
    print('reaading 3rd blk',end3-start3)      
