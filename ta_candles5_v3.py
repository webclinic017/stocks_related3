...
####    print(iday.columns)
    ...
    iday.reset_index(drop=False,inplace=True)    
    print('sleeptrain',iday)
    print(iday.columns)
###################################################################
#############################
...
##    iday=pd.concat(df['Datetime'],[df['ticker'],df['Close'],df['3-day Exponential MA'],
...
##
    ...
    t=pd.concat([iday['ticker'],iday['Close'],iday['3-day Exponential MA'],iday['5-day Exponential MA'],iday['10-day Exponential MA']])
    print('ffff',t)
    iday=pd.concat([iday['Datetime'],iday['ticker'],iday['Close'],iday['3-day Exponential MA'],
                                   iday['5-day Exponential MA'],iday['10-day Exponential MA'],
                                   iday['20-day Exponential MA'],iday['50-day Exponential MA'],
                                   iday['100-day Exponential MA'],iday['200-day Exponential MA']
                                   ],axis=1)
    ...
    i=0
    for x in iday.index:
##        print(' 3day/shift ',iday['Date'].loc[x],iday['3-day Exponential MA'].loc[x].round(0)-iday['3-day Exponential MA'].shift(1).loc[x].round(0))
              
##        print(iday['Close'].loc[x] , iday['3-day Exponential MA'].loc[x],iday['3-day Exponential MA'].shift(1).loc[x])
        if (iday['3-day Exponential MA'].loc[x].round(0)-iday['3-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            
            if iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x] > 0:
                iday['3-MA'].loc[x]=" ---> BUY-3-MA uptrend *** "
                iday['3-MA #'].loc[x]=(iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x] < 0:
                iday['3-MA'].loc[x]=" *** BUY?(close<3MA)-3-MA uptrend *** "
                iday['3-MA #'].loc[x]=(iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['3-day Exponential MA'].loc[x].round(0)-iday['3-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x] > 0:
                iday['3-MA'].loc[x]=" *** SELL?(close>3MA)-3-MA DWNtrend *** "
                iday['3-MA #'].loc[x]=(iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x] < 0:
                iday['3-MA'].loc[x]=" <--- SELL-3-MA DWNtrend *** "
                iday['3-MA #'].loc[x]=(iday['Close'].loc[x] - iday['3-day Exponential MA'].loc[x]).round(0)
                

            else:
                pass
##    print('office_walnut',iday)            
##################################################
#add

        if (iday['5-day Exponential MA'].loc[x].round(0)-iday['5-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            

            if iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x] > 0:
                iday['5-MA'].loc[x]=" ---> BUY-5-MA uptrend *** "
                iday['5-MA #'].loc[x]=(iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x] < 0:
                iday['5-MA'].loc[x]=" *** BUY?(close<5-MA)-5-MA uptrend *** "
                iday['5-MA #'].loc[x]=(iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['5-day Exponential MA'].loc[x].round(0)-iday['5-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x] > 0:
                iday['5-MA'].loc[x]=" *** SELL?(close>5-MA)-5-MA DWNtrend *** "
                iday['5-MA #'].loc[x]=(iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x] < 0:
                iday['5-MA'].loc[x]=" <--- SELL-5-MA DWNtrend *** "
                iday['5-MA #'].loc[x]=(iday['Close'].loc[x] - iday['5-day Exponential MA'].loc[x]).round(0)
...
###add
##
        if (iday['10-day Exponential MA'].loc[x].round(0)-iday['10-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            

            if iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x] > 0:
                iday['10-MA'].loc[x]=" ---> BUY-10-MA uptrend *** "
                iday['10-MA #'].loc[x]=(iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x] < 0:
                iday['10-MA'].loc[x]=" *** BUY?(close<10-MA)-10-MA uptrend *** "
                iday['10-MA #'].loc[x]=(iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['10-day Exponential MA'].loc[x].round(0)-iday['10-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x] > 0:
                iday['10-MA'].loc[x]=" *** SELL?(close>10-MA)-10-MA DWNtrend *** "
                iday['10-MA #'].loc[x]=(iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x] < 0:
                iday['10-MA'].loc[x]=" <--- SELL-10-MA DWNtrend *** "
                iday['10-MA #'].loc[x]=(iday['Close'].loc[x] - iday['10-day Exponential MA'].loc[x]).round(0)
...
###add
##
        if (iday['20-day Exponential MA'].loc[x].round(0)-iday['20-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            

            if iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x] > 0:
                iday['20-MA'].loc[x]=" ---> BUY-20-MA uptrend *** "
                iday['20-MA #'].loc[x]=(iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x] < 0:
                iday['20-MA'].loc[x]=" *** BUY?(close<20-MA)-20-MA uptrend *** "
                iday['20-MA #'].loc[x]=(iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['20-day Exponential MA'].loc[x].round(0)-iday['20-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x] > 0:
                iday['20-MA'].loc[x]=" *** SELL?(close>20-MA)-20-MA DWNtrend *** "
                iday['20-MA #'].loc[x]=(iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x] < 0:
                iday['20-MA'].loc[x]=" <--- SELL-20-MA DWNtrend *** "
                iday['20-MA #'].loc[x]=(iday['Close'].loc[x] - iday['20-day Exponential MA'].loc[x]).round(0)
                
##    print('office_walnut',iday)
#add

        if (iday['50-day Exponential MA'].loc[x].round(0)-iday['50-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            

            if iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x] > 0:
                iday['50-MA'].loc[x]=" ---> BUY-50-MA uptrend *** "
                iday['50-MA #'].loc[x]=(iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x] < 0:
                iday['50-MA'].loc[x]=" *** BUY?(close<50-MA)-50-MA uptrend *** "
                iday['50-MA #'].loc[x]=(iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['50-day Exponential MA'].loc[x].round(0)-iday['50-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x] > 0:
                iday['50-MA'].loc[x]=" *** SELL?(close>50-MA)-50-MA DWNtrend *** "
                iday['50-MA #'].loc[x]=(iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x] < 0:
                iday['50-MA'].loc[x]=" <--- SELL-50-MA DWNtrend *** "
                iday['50-MA #'].loc[x]=(iday['Close'].loc[x] - iday['50-day Exponential MA'].loc[x]).round(0)
...
###add
        ...
        if (iday['100-day Exponential MA'].loc[x].round(0)-iday['100-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            

            if iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x] > 0:
                iday['100-MA'].loc[x]=" ---> BUY-100-MA uptrend *** "
                iday['100-MA #'].loc[x]=(iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x] < 0:
                iday['100-MA'].loc[x]=" *** BUY?(close<100-MA)-100-MA uptrend *** "
                iday['100-MA #'].loc[x]=(iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['100-day Exponential MA'].loc[x].round(0)-iday['100-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x] > 0:
                iday['100-MA'].loc[x]=" *** SELL?(close>100-MA)-100-MA DWNtrend *** "
                iday['100-MA #'].loc[x]=(iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x] < 0:
                iday['100-MA'].loc[x]=" <--- SELL-100-MA DWNtrend *** "
                iday['100-MA #'].loc[x]=(iday['Close'].loc[x] - iday['100-day Exponential MA'].loc[x]).round(0)
...
###add
        ...
        if (iday['200-day Exponential MA'].loc[x].round(0)-iday['200-day Exponential MA'].shift(1).loc[x].round(0)) > 0:
            

            if iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x] > 0:
                iday['200-MA'].loc[x]=" ---> BUY-200-MA uptrend *** "
                iday['200-MA #'].loc[x]=(iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x]).round(0)
                
            elif iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x] < 0:
                iday['200-MA'].loc[x]=" *** BUY?(close<200-MA)-200-MA uptrend *** "
                iday['200-MA #'].loc[x]=(iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x]).round(0)
        ...
        if (iday['200-day Exponential MA'].loc[x].round(0)-iday['200-day Exponential MA'].shift(1).loc[x].round(0)) < 0:
            ...
            if iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x] > 0:
                iday['200-MA'].loc[x]=" *** SELL?(close>200-MA)-200-MA DWNtrend *** "
                iday['200-MA #'].loc[x]=(iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x]).round(0)
                

            elif iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x] < 0:
                iday['200-MA'].loc[x]=" <--- SELL-200-MA DWNtrend *** "
                iday['200-MA #'].loc[x]=(iday['Close'].loc[x] - iday['200-day Exponential MA'].loc[x]).round(0)
                


    print('pp office_walnut',iday)
########################################################################    
