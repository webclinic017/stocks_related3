...
pd.options.display.column_space=16
...
##    dfi=dfi['Volume'] > 0
    ...
    dfi=dfi[['ticker', 'Datetime', 'stragety', 's', 'HA_Signal', 'HA', 's', 'price_shift', 'Close', 'Volume', 's', '3-MA Entr_Signal',
             '5-MA Entr_Signal', '10-MA Entr_Signal', '20-MA Entr_Signal', '50-MA Entr_Signal', '100-MA Entr_Signal', '200-MA Entr_Signal',
             's', '3-MA-Exit_Signal', '5-MA-Exit_Signal', '10-MA-Exit_Signal', '20-MA-Exit_Signal', '50-MA-Exit_Signal', '100-MA-Exit_Signal',
             '200-MA-Exit_Signal', 'exit_signal_(>0)', 'exit_signal_(<0)', 'Enter_signal_(>0)', 'Enter_signal_(<0)', 'tot_Enter_signal',
             'tot_Exit_signal','s','price_shift', 'Close', 'Volume','s', 'HA_Signal', 'HA', 's', 'SELL_CALL_Enter_signal_(<0)', 'SELL_CALL_Exit_signal_(>0)','s','SELL_PUT_Enter_signal_(>0)', 'Sell_PUT_EXIT_signal_(<0)']]
    print('Hourly chart ----->  ',dfi.tail(223))
    print('columns',dfi.columns)
########################################################################    
##g='googl'
g='^NDX'
##g='^DJI'
