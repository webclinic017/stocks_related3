...
##ticker='NVDA'
#ticker='AMZN'
df = yf.download(ticker, period='1d', interval='5m',prepost = True)
df=pd.DataFrame(df)
...
##print(df3,'   peter')
##print('\n\n')
##df3['s3']=pd.concat((df3['s3'],df['s4']),axis=1)
##print(s3,'ggggs')
##sys.exit()
...
##print(df4,' 4444cccc')
##print(df4.shape,'54')
##df4.drop(df4.columns[7], axis=1,inplace=True)
##print(df4,'55')
############## @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
##to_datetime()

# pd.to_datetime(df4["s5"])
##df4.drop(df4.columns[[6,7,10]], axis=1,inplace=True)
##sys.exit()
df4["s5"] = ''
##print('\n\n')
...
##c=0
##for x in Red_V_cts[len(Red_V_cts)-5:]:
##    c+=x
##print('Last 5 mins - Red_sell_Volume: ',c)
##print('\n\n')
##print(df4.shape,df4.iloc[:,6])
##print(df4.columns)
...
for x in df4.index:
##    df4['Volume'].loc[x][0]=numerize.numerize(np.int64(df4['Volume'].loc[x][0]).item())
##    df4['Volume'].loc[x]=77
##    print(numerize.numerize(np.int64(df4['Volume'].loc[x][0]).item()),df4['Volume'].loc[x][0],type(df4['Volume'].loc[x][0])())
##    pd.to_numeric(df4['Volume'].loc[x], errors='coerce')
##    print(type(df4['Volume'].loc[x][0]))
...
##    if float(df4['n'].loc[x]) > float(0):
##    df4['n'].loc[x]=numerize.numerize(float(df4['n'].loc[x]))
##    df4['lk'].loc[x]=numerize.numerize(np.int64(df4['lk'].loc[x]).item())
##    df4['lk'].loc[x]=numerize.numerize(np.float64(df4['lk'].loc[x]).item())
##    df4['Volume'].loc[x]=numerize.numerize(np.float32(df4['Volume'].loc[x]).item())
##    df4['Green'].loc[x]=numerize.numerize(np.float32(df4['Green'].loc[x][0]).item())
##    df4['Red'].loc[x]=numerize.numerize(np.float32(df4['Red'].loc[x][0]).item())
