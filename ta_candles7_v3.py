...
##    df5=df5[['stragety','direct','Datetime','price_shift','Close','Volume','ticker','HA','3-MA #', '5-MA #', '10-MA #', '20-MA #', '50-MA #', '100-MA #',
##             '200-MA #','3-MA-E','200-MA-E','5-MA-E','10-MA-E','20-MA-E','50-MA-E','100-MA-E','200-MA-E']]
...
##        print(df5['Close'].loc[x] , df5['3-day Exponential MA'].loc[x],df5['3-day Exponential MA'].shift(1).loc[x])
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=3, adjust=False).mean().loc[x] < 0:
            df5['3-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=3, adjust=False).mean().loc[x])
...
#add
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=5, adjust=False).mean().loc[x] < 0:
            df5['5-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=5, adjust=False).mean().loc[x])
...
##
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=10, adjust=False).mean().loc[x] < 0:
            df5['10-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=10, adjust=False).mean().loc[x])
...
##
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=20, adjust=False).mean().loc[x] < 0:
            df5['20-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=20, adjust=False).mean().loc[x])
...
#add
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=50, adjust=False).mean().loc[x] < 0:
            df5['50-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=50, adjust=False).mean().loc[x])
...
###add
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=100, adjust=False).mean().loc[x] < 0:
            df5['100-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=100, adjust=False).mean().loc[x])
...
###add
        ...
        if df5['Close'].loc[x] - df5['Close'].ewm(span=200, adjust=False).mean().loc[x] < 0:
            df5['200-MA-E'].loc[x]= (df5['Close'].loc[x] - df5['Close'].ewm(span=200, adjust=False).mean().loc[x])
...
##            dfi['3-MA-E']='Exit'
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=3, adjust=False).mean().loc[x] < 0:
            dfi['3-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=3, adjust=False).mean().loc[x])
...
##            pass
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=5, adjust=False).mean().loc[x] < 0:
            dfi['5-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=5, adjust=False).mean().loc[x])
...
##            dfi['10-MA-E']='Exit'
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=10, adjust=False).mean().loc[x] < 0:
            dfi['10-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=10, adjust=False).mean().loc[x])
...
##            dfi['20-MA-E']='Exit'
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=20, adjust=False).mean().loc[x] < 0:
            dfi['20-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=20, adjust=False).mean().loc[x])
...
##            dfi['50-MA-E']='Exit'
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=50, adjust=False).mean().loc[x] < 0:
            dfi['50-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=50, adjust=False).mean().loc[x])
...
##            dfi['100-MA-E']='Exit'
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=100, adjust=False).mean().loc[x] < 0:
            dfi['100-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=100, adjust=False).mean().loc[x])
...
##            dfi['200-MA-E']='Exit'
        ...
        if dfi['Close'].loc[x] - dfi['Close'].ewm(span=200, adjust=False).mean().loc[x] < 0:
            dfi['200-MA-E'].loc[x]= (dfi['Close'].loc[x] - dfi['Close'].ewm(span=200, adjust=False).mean().loc[x])
...
##        dfi['3-MA #'].loc(x)=dfi['3-MA #'].loc(x)
    ...
    dfi=dfi[['ticker','Datetime','stragety','s','direct','HA','s','price_shift','Close','Volume','s',
             '3-MA #', '5-MA #', '10-MA #', '20-MA #', '50-MA #', '100-MA #','s',
             '200-MA #','3-MA-E','200-MA-E','5-MA-E','10-MA-E','20-MA-E','50-MA-E','100-MA-E','200-MA-E']]
