...
##print(gft2,'----')
##sys.exit()
xs,df,buy_price_gg,sell_price_gg,b6,s7,buy_status,sell_status,gft,gft2=ta(m,gft,gft2)
print('from main')
print(xs,df,buy_price_gg,sell_price_gg,b6,s7,buy_status,sell_status,gft,gft2)
print('end from main')
##print('\n\n')
##print(gft,'**************')
