...
##    print('\n\n')
    ...
    print('*************************************************************************')
    print(ticker)
    print('214 695 Last price--> ',gg33b['Close'].loc[gg33b.shape[0]-1])
    print('\n')
    print('*************************************************************************')
    print('\n')
...
##        print('Price [down] from signal: ******  ',gg33b['Close'].loc[gg33b.shape[0]-1]-gg33b['Close'].loc[a], ' ******')
        ...
        print('5_10_[sell]_signal','signal @ ',gg33b['Close'].loc[a],' Current @ :',gg33b['Close'].loc[gg33b.shape[0]-1], 'big')
##        print('Price [down] from signal: ******  ',gg33b['Close'].loc[gg33b.shape[0]-1]-gg33b['Close'].loc[a], ' ******')
...
##        f.close
    ...
    if p8_5_10_s[a] < p8_5_10_b[b]:
        print('5_10_[buy]_signal'+' Price @ ' + gg33b['Close'].loc[b] +'** Current @:' + gg33b['Close'].loc[gg33b.shape[0]-1] + ' small')
...
##    print('\n\n')
    ...
    if  p8_10_21_s[a] >  p8_10_21_b[b]:
        print('10_21_[sell]_signal')
    if p8_10_21_s[a] < p8_10_21_b[b]:
        print('10_21_[buy]_signal','   ',"df['10_21_crossovr'].loc[x]=df['EMA_10s'].loc[x]-df['EMA_21s'].loc[x]")
#############################################################        
        #############################################################
...
##    print('\n\n')
    ...
    if p8_21_50_s[a] > p8_21_50_b[b]:
        print('21_50_[sell]_signal')
    if p8_21_50_s[a] < p8_21_50_b[b]:
        print('21_50_[buy]_signal','   ',"df['21_50_crossovr'].loc[x]=df['EMA_21s'].loc[x]-df['EMA_50s'].loc[x]")
...
##    print('\n\n')
    ...
    if p8_50_100_s[a] > p8_50_100_b[b]:
        print('50_100_[sell]_signal')
    if p8_50_100_s[a] < p8_50_100_b[b]:
        print('50_100_[buy]_signal','   ',"df['50_100_crossovr'].loc[x]=df['EMA_50s'].loc[x]-df['EMA_100s'].loc[x]")
...
########################################################
    ...
    if p8_100_200_s[a] > p8_100_200_b[b]:
        print('100_200_[sell]_signal')
    if p8_100_200_s[a] < p8_100_200_b[b]:
        print('100_200_[buy]_signal','   ',"df['100_200_crossovr'].loc[x]=df['EMA_100s'].loc[x]-df['EMA_200s'].loc[x]")
