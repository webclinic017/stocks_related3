...
http://blog.adnansiddiqi.me/getting-started-with-ccxt-crypto-exchange-library-and-python/
...
symbol=['ETH/BTC','BTC/USDT']

for symbol in client.get_symbol_info:
    print (client.fetch_order_book(symbol))
    time.sleep (delay) # rate limit

##print(fetchTickers ([ 'ETH/BTC', 'BTC/USDT' ]))
...
print(client.get_max_margin_loan(asset='BTC'))
...
##print(client.get_margin_trades(symbol='BNBBTC'))
##print(client.get_all_margin_orders(symbol='BNBBTC', limit=10))
...
for x in client.get_orderbook_tickers():
    print(x)
