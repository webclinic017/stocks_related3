...
def read_tickers_from_file_and_align():
    import os
...
##        print(i,') ',x)
    ...
    print(df)
    df.to_csv('/home/az2/output45555.xlsx')
    print('Output is located at: ',
          '/home/az2/output45555.xlsx')

def file_to_output():
    import pandas as pd
    t=pd.read_csv('/home/az2/output45555b.csv', sep=';')
...
##    t.set_index('symbol',inplace=True)
    ...
    print(t.sort_values(by=['marketCap'],ascending=False),' sorted by highest marketcap')
    t.to_csv('/home/az2/sorted_by_highest_market_cap.csv')
    
    print(t.sort_values(by=['volume'],ascending=False),' sorted by volume')
    ...
    t5=t.loc[t['averageDailyVolume10Day']> 800000]
...
read_tickers_from_file_and_align()
p=yfinanceb_to_file()
print(p)
file_to_output()
