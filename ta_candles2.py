...
def uu():
    ...
    df = yf.download(ticker, '2021-05-1','2021-06-29', index=False)
    ##df=df.iloc[6:,:]
    ##print(df)
    ##print('baba',df.shape)
...
####    iday = intraday.loc[1:30,:]
    iday = intraday.loc['2021-01-10 09:30:00-04:00':'2021-06-18 15:34:00-04:00',:]
...
##                 linewidths=1)
    line2 = dict(alines=[['2021-06-15 10:00:00-04:00',25],['2021-06-15 10:00:00-04:00',77]],
                 linewidths=1)
##    print(line2)
##    hlines = {}
##    hlines['values'] = 55
...
##    mpf.plot(iday,type='candle',alines=line,figscale=0.75)

    apds = [ 
             mpf.make_addplot( [55.0], linestyle='-' ),
             mpf.make_addplot( [45.0], linestyle='--' ),
             mpf.make_addplot( [30.0], linestyle='-.' )
       ]



    mpf.plot(iday, type='candle', volume=True, figratio=(15, 15), style='yahoo', mav=(3, 7,13,50), title=ticker+' - ('+perd + ' - '+intervl+')'
##             ,alines=line2 , figscale=0.2,
             ,addplot=apds, hlines=dict(hlines=niveles, linewidths=1, colors='k')
                                        )


##     apds = [mpf.make_addplot(iday,scatter=True,markersize=100,marker='^'),
##                mpf.make_addplot(iday,scatter=True,markersize=100,marker='v'),
...
##    df_lines = pd.DataFrame(df['Close'].dropna())
##    lines = list(df_lines.itertuples(index=True, name=None))
##
##    Walls=[ ( ['2021-06-15 10:00:00-04:00',2],['2021-06-18 10:00:00-04:00',77] ),
##        ( ['2021-06-15 10:00:00-04:00',3],['2020-05-18 13:00:01',55] )
##      ]
##
##    mpf.plot(iday, type='candle', figratio=(20,9), style=s, alines=[dict(alines=Walls,colors=['w']), dict(alines=Walls2,colors=['g'])] )
##
##
##
##
...
##
####    iday = intraday.loc[1:30,:]
    iday = intraday.loc['2021-06-23 09:30:00-04:00':'2021-06-24 17:44:00-04:00' ,:]
