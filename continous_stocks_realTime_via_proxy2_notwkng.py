...
##    dp=pd.DataFrame(d2)
##    dp=pd.concat([d2,d3],axis=1)    
    dp=pd.DataFrame([d2,d3,d4,d5])
    dm=dp.T
    dm=dm.tail(1)
##    print('\n')
##    print('*****************************************************')
...
##s=['btc-usd']
s=['spy']
s3=['spy','btc-usd','DOCU','tsla','^NDX','SPY','QQQ','^DJI','^GSPC','ARKK','TNA','coin','mstr','mrna','bntx','zm','nvax','tsla','googl','msft',
   'snow','now','nvda','lcid','qcom','adbe','asml','txn','amc','avgo','nsflx','didi']
