...
def Part1():
    ...
    breakz=1000
    ##########################################
##    os.remove('\home\az2\Downloads\dfv33.csv')
##    os.remove('\home\az2\Downloads\dfp33.csv')
    prices(n2,n4,breakz)
    volume(n2,n4,breakz)
##
##dfv=volume()
...
def Part2():
    ...
    print(df33.sort_values(by=['Diff_%_P'],ascending=False),'  Output file/Price and volume')
    print(df33.head(4))
...
####    del (x)
####    f.write(x)
##    f.write(str(' ffffffffffffffffffffffffff '))
##    f.write('\n')        
##    i=i+1    
##f.close
##print('finish')
