...
df2=df2[1:]
print(df2,'          df2')
##df2=df2.columns['5','55']
##df2=df2.columns['aa','ff']
##
...
df2['c']=df2.iloc[:,'88']-df2.iloc[:,'2']

##df2['c']=df2.iloc[:,0]-df2.iloc[:,1]

##df2=pd.DataFrame(df2.iloc[:,0],df2.iloc[:,1],df2.iloc[:,2])
##df2.sort_values(['c'], ascending = False)
##df2 = df2.sort_values(by=['2', '88', 'c'], ascending=[False, False, False])
##
##print('\n\n')
##print(df2['c','88'])
##print('\n')
...
##print(df3.columns['ff'])
##print(df3)
####df3=df3.columns['a']
####df3.sort_values(ascending=True,axis=0)
##
##print(df3.columns)
######    
####
