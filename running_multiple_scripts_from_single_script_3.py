...
### ok
##pipe = sp.Popen('grep -H -n "popen" /home/az2/Downloads/*.py', shell=True, stdout=sp.PIPE, stderr=sp.PIPE )
...
f=open('/home/az2/Downloads/animate_files33.txt')
#f=open('/home/az2/animate_nnn.txt')
##f=open(str(p6a),'r')
for x in f:
##    print(str(x).split(':')[0])
