...
def part2(QQQ,datep):        
    ...
    f=open(str('/home/az2/Downloads/44pp/')+str(QQQ[0])+str('_calls.txt'))
...
##    print(dfc[['strikePrice','putCall','symbol','description','mark','bidSize','askSize','lastSize','theoreticalVolatility','totalVolume','daysToExpiration']])
    ...
    f=open(str('/home/az2/Downloads/44pp/')+str(QQQ[0])+str('_puts.txt'))
##    print(f)
    data = f.read()
##    print(data,' nnn')
    ##    js = json.loads(data)
