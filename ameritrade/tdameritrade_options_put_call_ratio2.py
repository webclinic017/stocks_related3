...
def part2():        
    import json
    import ast
    with open('/home/az2/Downloads/44pp/QQQ_calls.txt') as f:
        data = f.read()
    ##    print(data,' nnn')
    ##    js = json.loads(data)
    ##    js = json.loads(data)
    ...
    print(df[['strikePrice','putCall','symbol','description','mark','bidSize','askSize','lastSize','theoreticalVolatility','totalVolume','daysToExpiration']])
    print('Call    ',df['totalVolume'].sum())
