...
# sabir test
        if df['Close'].loc[x] > 440 and df['Close'].loc[x] < 441:
...
#######################################################################################################            
                ...
                df['signal'].loc[k3s]='** Major Sell_Signal'
                m33n=df['Close'].loc[k3s]    
                df['signal'].loc[k3s]='///Sell_Signal'
##             print("sell ---->",)
...
##                      k3s,'****   buy= ',m33.round(2), ' buy row no k3=',k3)
                ...
                print('(sell signal--> )',df['Datetime'].loc[k3s],'  ',m33.round(2),'/',(m33n).round(2),'  ','[profit]=',(m33n-m33).round(2), '  in ',t ,' minutes', "sell= ", m33n.round(2),'sell row= ',
                      k3s,'****   buy= ',m33.round(2), ' buy row no k3=',k3)
