...
##        x,for x in mt3:
####            print(x)
##        nnp = [mt3[x] for x in range(0,len(mt3))]
##        print(nnp)
...
##        bst = [x  for x in mt3]
##        print(bst)
##        print('0',mt3[0],'    ','1',mt3[1])
##        sys.exit()    


        bb7=[print(i) for i in mt3]
        bb8=[print('g') for i in mt3]
##        print(bb7)
        ...
        ##     + ', day swing: ' + str(u3).split('.')[0],
                 style=s,
             show_nontrading=False,hlines=dict(hlines=[cto,c1day],colors=['g','r'],linestyle='-.')
             ,vlines=dict(vlines=[[mt3],[m21]],colors=['g','g','g','g','r','r','r','r','r']
