...
##    ##print(df,'88')
    ...
    df7=pd.DataFrame(columns=['stragety','Date','ticker','Buy_at','Sell_at','Profit','b_Close_vwap','b_macd','b_mom','b_VZO','b_CCI'])
    print('\n\n\n\n')
...
##        s5d={'f2':'34','f3':'55'}
        s5d={'stragety':'2','Date':str(u33),'ticker':s45,'Buy_at':v4,'Sell_at':v5,'Profit':v4-v5,'b_Close_vwap':'4','b_macd':'3','b_mom':'4','b_VZO':'3','b_CCI':'3'}
        df7=df7.append(s5d,ignore_index=True)
        print(df7,'--------------- gg55')
