...
##df = yf.download('tsla', period='90d', interval='1d', index=False)
# Plot candlestick.
# Add volume.
...
s = mpf.make_mpf_style(base_mpl_style='ggplot')
...
mpf.plot(df, title=ticker, type='candle', style=s, ylabel='Price'
    , addplot=ap,
